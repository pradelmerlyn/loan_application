...
part 'property_address_entity.g.dart';

@JsonSerializable()
class PropertyAddressEntity extends Equatable {
  @JsonKey(name: 'id')
  final String? id;
  ...
  factory PropertyAddressEntity.fromJson(Map<String, dynamic> json) =>
      _$PropertyAddressEntityFromJson(json);

  Map<String, dynamic> toJson() => _$PropertyAddressEntityToJson(this);
}
