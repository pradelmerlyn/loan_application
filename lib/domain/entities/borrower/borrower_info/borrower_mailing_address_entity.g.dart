...
part of 'borrower_mailing_address_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BorrowerMailingAddressEntity _$BorrowerMailingAddressEntityFromJson(
        Map<String, dynamic> json) =>
    BorrowerMailingAddressEntity(
...
Map<String, dynamic> _$BorrowerMailingAddressEntityToJson(
        BorrowerMailingAddressEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      'line': instance.line,
