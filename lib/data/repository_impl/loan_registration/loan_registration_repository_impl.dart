...
// import the MODELS (not entities) you’ll construct
...
class LoanRegistrationRepositoryImpl implements LoanRegistrationRepository {
  ...
  @override
  Future<DataState<LoanRegistrationEntity>> createLoanId({
    ...
    try {
      final model = LoanRegistrationModel(
        ...
        coBorrower: payload.coBorrower != null
            ...
            : null,
        assets: payload.assets?.map((e) => AssetModel.fromEntity(e)).toList(),
      ...
      final res = await _service.createLoanId('Bearer $token', model);
